    ...
    <div class="discuss-inner">
        ...
        <div v-if="discussInfo.count != 0" class="discuss-list-title">
            <div class="top">
                ...
                <div class="tip">
                    (有<span>{{discussInfo.count}}</span>条评论)
                </div>
            </div>
            <div class="new-discuss">最新评论</div>
            <div class="out" v-for="outItem in discussInfo.list" :key="outItem._id">
                ...
                <div class="inner" v-for="innerItem in outItem.replys" :key="innerItem._id">
                    <discuss-item :zone='zone' :remarkId='outItem._id' :inner='true' :discussItem='innerItem'></discuss-item>
                </div>
            </div>
        </div>
    ...
    methods: {
        async init(){
            ...
            if(result.data.code == 1){
                this.discussInfo = result.data.data
            }
        }
    }
}
